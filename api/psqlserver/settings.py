...
VNPAY_TMN_CODE = '2FB67LT2'  # Website ID in VNPAY System, get from config
VNPAY_HASH_SECRET_KEY = 'PXLKKGIQSXIUUZHUUPXUTNXDNFFWSBAD'  # Secret key for create checksum,get from config
