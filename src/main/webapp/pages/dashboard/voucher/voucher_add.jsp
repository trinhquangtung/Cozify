          ...
          <div class="card-body">
            ...
            <form method="post" action="add" class="needs-validation" novalidate="">
              ...
              <div class="mb-3">
                ...
                <input type="text" required="" maxlength="200" class="form-control" id="voucherName" name="voucherName"
                       placeholder=""
                       value="">
              ...
              <div class="mb-3">
                ...
                <input type="text" required="" maxlength="16" pattern="[a-zA-Z0-9]{16}" class="form-control" id="voucherCode"
                       name="voucherCode" placeholder=""
                       value="">
              ...
              <div class="mb-3">
                <label  for="voucherPercent" class="form-label">Value (percentage) <span
                    class="text-danger">*</span></label>
                    <input type="number" required="" step="1" min="1" max="100" pattern="[0-9]{1,}" class="form-control"
                       id="voucherPercent" name="voucherPercent"
                       placeholder="" value="">
              ...
              <div class="mb-3">
                ...
                <input type="number" required="" step="1" min="0" pattern="[0-9]{1,}" class="form-control" id="voucherQuantity"
              ...
              <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="check-disable" name="isHidden"
                       value="true">
