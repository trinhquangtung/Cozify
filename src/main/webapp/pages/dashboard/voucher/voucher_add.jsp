          ...
          <div class="card-body">
            ...
            <form method="post" action="add" class="needs-validation" novalidate="">
              ...
              <div class="mb-3">
                ...
                <input type="text" maxlength="200" class="form-control" id="voucherName" name="voucherName"
                       placeholder=""
                       value="">
              ...
              <div class="mb-3">
                ...
                <input type="text" maxlength="16" pattern="[a-zA-Z0-9]{16}" class="form-control" id="voucherCode"
              ...
              <div class="mb-3">
                ...
                <input type="number" step="1" min="0" max="100" pattern="[0-9]{1,}" class="form-control"
              ...
              <div class="mb-3">
                ...
                <input type="number" step="1" min="0" pattern="[0-9]{1,}" class="form-control" id="voucherQuantity"
