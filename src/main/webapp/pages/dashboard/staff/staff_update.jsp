        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="update" class="needs-validation" novalidate="">
              ...
              <div class="mb-3">
                <label for="username" class="form-label">User ame <span class="text-danger">*</span></label>
              ...
              <div class="mb-3">
                ...
                <input type="email" maxlength="255" pattern="[a-z0-9](\.?[a-z0-9]){2,}@g(oogle)?mail\.com"
              ...
              <div class="mb-3">
                ...
                <input type="tel" class="form-control" maxlength="10" pattern="[0]{1}\d{9}" id="phoneNumber"
                       name="phoneNumber"
                       placeholder="" value="${staff.phoneNumber}">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" maxlength="255" id="address" name="address"
                       placeholder="" value="${staff.address}">
