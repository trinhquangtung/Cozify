          ...
          <div class="card-body">
            ...
            <form method="post" action="add" class="needs-validation" novalidate="">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="categoryName" name="categoryName" aria-describedby="nameHelp" placeholder="" required="">
              ...
              <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="check-disable">Disable this category upon creation</label>
              </div>
